...
function sampleRunDetail(): RunDetail {
	const attempt: AttemptRecord = {
		...
		retrievalHooks: [],
		attackTelemetry: null,
		benignTaskAnswer: null,
		benignUsedDocs: null,
		benignSuspiciousInstructionDetected: null,
		benignToolCalledSelfReport: null,
		benignSensitiveDataExposed: null,
		benignStructuredParseOk: null,
